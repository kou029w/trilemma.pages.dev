...
const TRILEMMAS = [
  ...
  },
  {
    ...
    author: "Martin Barnes, 1969", color: "#F97316",
    elements: ["品質", "コスト", "スケジュール"],
    subelements: ["Scope/Quality", "Cost", "Time"],
    desc: "早く・安く・良いものは同時に実現できない。プロジェクト管理の根本的制約",
  },
  {
  ...
  {
    id: "energy_trilemma", domain: "environment",
    name: "エネルギートリレンマ", nameEn: "Energy Trilemma",
    author: "世界エネルギー会議（WEC）, 2010", color: "#86EFAC",
    elements: ["エネルギー安全保障", "エネルギー公平性", "環境持続可能性"],
    subelements: ["Energy Security", "Energy Equity", "Environmental Sustainability"],
    desc: "各国のエネルギー政策は安全保障・公平なアクセス・環境保護を同時に最大化できない",
  },
  {
    id: "healthcare_iron_triangle", domain: "society",
    name: "医療の鉄の三角形", nameEn: "Healthcare Iron Triangle",
    author: "William Kissick, 1994", color: "#F472B6",
    elements: ["医療の質", "アクセス", "コスト"],
    subelements: ["Quality", "Access", "Cost"],
    desc: "医療制度は高品質・広いアクセス・低コストを同時に達成できない",
  },
  {
    id: "ai_alignment", domain: "tech",
    name: "AIアライメントのトリレンマ", nameEn: "AI Alignment Trilemma",
    author: "AI安全研究コミュニティ, 2020s", color: "#60A5FA",
    elements: ["能力", "安全性", "解釈可能性"],
    subelements: ["Capability", "Safety", "Interpretability"],
    desc: "高度なAIシステムは高い能力・安全性・透明性（解釈可能性）を同時に最大化できない",
  },
  {
    id: "electoral_trilemma", domain: "society",
    name: "選挙制度のトリレンマ", nameEn: "Electoral Systems Trilemma",
    author: "比較政治学（Arend Lijphart等）", color: "#A78BFA",
    elements: ["比例代表性", "地域代表性", "政府安定性"],
    subelements: ["Proportionality", "Geographic Representation", "Government Stability"],
    desc: "選挙制度は比例代表性・地域代表性・政府安定性の3つを同時に最大化できない",
  },
];
